...
public class MukDBContract {
    ...
    public static final String SQL_RECORD_WEEK_SELECT = "SELECT count(rcd_date), AVG(food_kcal) as food_kcal , AVG(food_moisture) as food_moisture , AVG(food_protein) as food_protein , AVG(food_fat) as food_fat , AVG(food_carbo) as food_carbo , AVG(food_sugars) as food_sugars , AVG(food_fiber) as food_fiber , AVG(food_calcium) as food_calcium , AVG(food_fe) as food_fe , AVG(food_magnesium) as food_magnesium , AVG(food_pho) as food_pho , AVG(food_pota) as food_pota , AVG(food_salt) as food_salt , AVG(food_zinc) as food_zinc , AVG(food_copper) as food_copper , AVG(food_mangan) as food_mangan , AVG(food_selenium) as food_selenium , AVG(food_iodine) as food_iodine , AVG(food_chlorine) as food_chlorine , AVG(food_vitaA) as food_vitaA , AVG(food_vitaARE) as food_vitaARE , AVG(food_retinol) as food_retinol , AVG(food_beta) as food_beta , AVG(food_vitaB) as food_vitaB , AVG(food_vitaD) as food_vitaD , AVG(food_panto) as food_panto , AVG(food_vitaB6) as food_vitaB6 , AVG(food_biotin) as food_biotin , AVG(food_vitaC) as food_vitaC , AVG(food_omega3_fatty_acids) as food_omega3_fatty_acids , AVG(food_omega6_fatty_acids) as food_omega6_fatty_acids FROM(SELECT rcd_date, sum(food_kcal) as food_kcal , sum(food_moisture) as food_moisture , sum(food_protein) as food_protein , sum(food_fat) as food_fat , sum(food_carbo) as food_carbo , sum(food_sugars) as food_sugars , sum(food_fiber) as food_fiber , sum(food_calcium) as food_calcium , sum(food_fe) as food_fe , sum(food_magnesium) as food_magnesium , sum(food_pho) as food_pho , sum(food_pota) as food_pota , sum(food_salt) as food_salt , sum(food_zinc) as food_zinc , sum(food_copper) as food_copper , sum(food_mangan) as food_mangan , sum(food_selenium) as food_selenium , sum(food_iodine) as food_iodine , sum(food_chlorine) as food_chlorine , sum(food_vitaA) as food_vitaA , sum(food_vitaARE) as food_vitaARE , sum(food_retinol) as food_retinol , sum(food_beta) as food_beta , sum(food_vitaB) as food_vitaB , sum(food_vitaD) as food_vitaD , sum(food_panto) as food_panto , sum(food_vitaB6) as food_vitaB6 , sum(food_biotin) as food_biotin , sum(food_vitaC) as food_vitaC , sum(food_omega3_fatty_acids) as food_omega3_fatty_acids , sum(food_omega6_fatty_acids) as food_omega6_fatty_acids\n" +
